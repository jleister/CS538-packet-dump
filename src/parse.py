...
global_header = "{\"magicNumber\": " + magic_dec
...
while EOF != "":
    ...
    record_header += "\"" + str(count) + "\": {\"tsSec\": " + str(int(ts_hex, 16))
    ...
    record_header += ", \"tsUSec\": " + str(int(tsu_hex, 16))
    ...
    record_header += ", \"inclLen\": " + str(int(incl_hex, 16))
    ...
    record_header += ", \"origLen\": " + str(int(orig_hex, 16)) + "}, \n"
